...
from src.query_enhancement import generate_hypothetical_document, contextualize_query, optimize_query
...
def get_answer(
    ...
    if golden_chunks and cfg.use_golden_chunks:
        ...
        # retrieval_queries, opt_meta = optimize_query(question, cfg, cfg.gen_model)
